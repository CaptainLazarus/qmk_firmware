...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [WIN_MATH] = LAYOUT_ansi_109(
			       _______, _______, _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
			       _______, _______, _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
			       _______, _______, _______,  _______,  _______,  _______,  _______,  UM(PSI),  _______,  _______, UM(SMALL_PI),  _______,  _______,    KC_PIPE,  _______,  _______,  _______,  _______,  _______,  _______,
			       MO(WIN_MATH_FUNCS), UM(ALPHA), _______,  _______,  _______,  UM(GAMMA),  _______,  _______,  _______,  _______,  _______,  _______,              _______,                                _______,  _______,  _______,  S(KC_EQL),
			       _______,          _______,  _______,  _______,  _______,  UM(BETA),  _______,  _______,  _______,  _______,  _______,              _______,            _______,            _______,  _______,  _______,
			       _______, _______, _______,                                _______,                                _______,  _______,  _______,    _______,  _______,  _______,  _______,  _______,            UM(DOT_OPERATOR),  _______),

  [WIN_MATH_FUNCS] = LAYOUT_ansi_109(
				     _______, _______, _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
				     _______, _______, _______,  _______,  _______,  _______,  _______,  _______,  _______,  UM(BRA),  UM(KET),  _______,  _______,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
